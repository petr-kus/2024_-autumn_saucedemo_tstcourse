...
problem_user = Credentials(username='problem_user', password='secret_sauce')
personal_glitch_user = Credentials(username='performance_glitch_user', password='secret_sauce')
...
wrong_credentials = [bad_password, generate_random_credentials()]
ok_credentials = [standard_user, problem_user, personal_glitch_user]
